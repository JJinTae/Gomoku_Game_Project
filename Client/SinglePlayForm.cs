...
namespace Client
{
    public partial class SinglePlayForm : Form
    {
        ...
        private bool playing = false; // 게임을 진행중인 상태인지 체크하기 위한 변수
        ...
        private void bordPictur_MouseDown(object sender, MouseEventArgs e)
        {
            if(!playing)
            {
            ...
            Graphics g = this.bordPictur.CreateGraphics();
            int x = e.X / rectSize;
            int y = e.Y / rectSize;
        ...
        private void bordPictur_Paint(object sender, PaintEventArgs e)
        {
            Graphics gp = e.Graphics;
            Color lineColor = Color.Black;
            Pen p = new Pen(lineColor, 2);
            gp.DrawLine(p, rectSize / 2, rectSize / 2, rectSize / 2, rectSize * edgeCount - rectSize / 2); // 가로
            gp.DrawLine(p, rectSize / 2, rectSize / 2, rectSize * edgeCount - rectSize / 2, rectSize / 2); // 좌측
        ...
        private void bordPictur_Click(object sender, EventArgs e)
        {
